<?php  //[STAMP] 10aa0ff92c09e437166fb3a0cf10662e
...
trait UITesterActions
{
     ...
     *
     *
     * @see \Helper\UI\UI::verifyTrue()
     */
    public function verifyTrue($condition) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyTrue', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\UI\UI::verifyFalse()
     */
    public function verifyFalse($condition) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyFalse', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\UI\UI::verifyEquals()
     */
    public function verifyEquals($expectedResult, $actualResult) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyEquals', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\UI\UI::verifyNotContains()
     */
    public function verifyNotContains($value, $actual) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyNotContains', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\UI\UI::verifyContains()
     */
    public function verifyContains($value, $actual) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyContains', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\UI\UI::verifyGreaterThanOrEquals()
     */
    public function verifyGreaterThanOrEquals($value, $actual) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyGreaterThanOrEquals', func_get_args()));
    }
